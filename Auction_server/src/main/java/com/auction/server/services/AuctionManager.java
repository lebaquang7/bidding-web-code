...
public class AuctionManager {
    ...
    //     java.util.Map<String, com.auction.shared.models.BidTransaction> bots = autoBidRegistry.get(auctionId);
    ...
    //                     System.out.println(" [Hệ thống] Bot [" + botUsername + "] tự động nâng giá lên: " + currentPrice + " VND");

    //                     if (auctionObj instanceof com.auction.shared.models.Auction) {
    //                         ((com.auction.shared.models.Auction) auctionObj).setCurrentPrice(currentPrice);
    //                     }
    //                 }
    //             }
    //         }
    //     } while (priceChanged); // Vòng lặp chạy liên tục cho đến khi không còn Bot nào đủ điều kiện đè giá nữa

    //     System.out.println(" AUTO-BID KẾT THÚC. NGƯỜI DẪN ĐẦU: [" + currentHighestUser + "] VỚI GIÁ: " + currentPrice + " VND");
    // }
}
